...
abstract class GOdialog {
  static showLoading(context, Widget loading,
      {String title: '正在加载...', height: 30.0, width: 30.0, close: false}) {
    showDialog(
        context: context,
  ...
  static showBottomSheet(context) {
    showModalBottomSheet(
        ...
        builder: (BuildContext context) {
          return Text('11');
          // return BottomSheet(builder: (BuildContext context) {  }, onClosing: () {  },);
        });
  }
}
